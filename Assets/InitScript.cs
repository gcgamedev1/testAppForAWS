...
public class InitScript : MonoBehaviour {
	...
	void Start () {
        ...
        // Add attributes
        customEvent.AddAttribute("SceneName", "scene4");
    ...
    IEnumerator LoadScene()
    {
        ...
        yield return SceneManager.LoadSceneAsync("scene4", LoadSceneMode.Additive);
    ...
    void SyncSuccessCallback(object sender, SyncSuccessEventArgs e)
    {
        ...
        {
            Debug.Log("[SCENE4] Successfully synced for dataset: " + dataset.Metadata);
        }
        else
        {
            Debug.Log("[SCENE4]  Successfully synced for dataset");
        }
    }
    ...
    {
        var dataset = sender as Dataset;
        Debug.Log("[SCENE4]  Sync failed for dataset : " + dataset.Metadata.DatasetName);
